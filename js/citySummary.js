class CitySummary {
    ...
    initiate(data) {
        var self = this;
        self.lines = this.formatData(data);

        // SVG
        self.svg = d3.select("#tipDiv")
                .append("svg")
                .attr("id", "citySumSVG")
    ...
    update() {
        ...
        let xScale = d3.scaleLinear()
                    .domain([self.current, self.maxYear])
                    .range([0, this.width]); 
